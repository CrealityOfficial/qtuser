...
#define PRIMITIVE_ADD(x, y)  m_primitiveShapes.insert(x, y); \
		...
		PRIMITIVE_ADD("point", pointGeometry)
			Qt3DRender::QGeometry* arrowGeometry = BasicShapeCreateHelper::createInstructions(0.03, 1.0, 0.085, 0.20);//ArrowCreateHelper::create();
		...
		Qt3DRender::QGeometry* scaleIndicatorGeometry = BasicShapeCreateHelper::createScaleIndicator(0.03, 1.0, 18, 0.20);
