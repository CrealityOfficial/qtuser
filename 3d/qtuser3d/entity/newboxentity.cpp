...
namespace qtuser_3d
{
	...
	void NewBoxEntity::updateBox(Box3D& box)
	{
		...
		m_colors[0] = QVector4D(0.6f, 0.6f, 0.6f, 1.0);
		m_colors[1] = QVector4D(0.6f, 0.6f, 0.6f, 1.0);
		m_colors[2] = QVector4D(0.6f, 0.6f, 0.6f, 1.0);
		m_colors[3] = QVector4D(0.6f, 0.6f, 0.6f, 1.0);
		m_colors[4] = QVector4D(0.6f, 0.6f, 0.6f, 1.0);
		m_colors[5] = QVector4D(0.6f, 0.6f, 0.6f, 1.0);
		m_colors[6] = QVector4D(0.6f, 0.6f, 0.6f, 1.0);
		m_colors[7] = QVector4D(0.6f, 0.6f, 0.6f, 1.0);
		m_colors[8] = QVector4D(0.6f, 0.6f, 0.6f, 1.0);
		m_colors[9] = QVector4D(0.6f, 0.6f, 0.6f, 1.0);
		m_colors[10] = QVector4D(0.6f, 0.6f, 0.6f, 1.0);
		m_colors[11] = QVector4D(0.6f, 0.6f, 0.6f, 1.0);
		m_colors[12] = QVector4D(0.6f, 0.6f, 0.6f, 1.0);
		m_colors[13] = QVector4D(0.6f, 0.6f, 0.6f, 1.0);
