...
namespace qtuser_3d
{
	...
	void HotbedEntity::drawFace(int faceNum)
	{
		...
		if (m_faceNum ==9)
		{
			...
			indices4.push_back(2); indices4.push_back(3); indices4.push_back(1);
			...
			indices5.push_back(2); indices5.push_back(3); indices5.push_back(1);
			...
			indices6.push_back(2); indices6.push_back(3); indices6.push_back(1);
			...
			indices3.push_back(2); indices3.push_back(3); indices3.push_back(1);
			...
			indices0.push_back(2); indices0.push_back(3); indices0.push_back(1);
			...
			indices7.push_back(2); indices7.push_back(3); indices7.push_back(1);
			...
			indices2.push_back(2); indices2.push_back(3); indices2.push_back(1);
			...
			indices1.push_back(2); indices1.push_back(3); indices1.push_back(1);
			...
			indices8.push_back(2); indices8.push_back(3); indices8.push_back(1);
			...
			m_hotZone.push_back(Box3D(QVector3D(small_unit, small_unit, 0), QVector3D(small_unit + unit, small_unit + unit, 0)));//D0
			m_hotZone.push_back(Box3D(QVector3D(small_unit + unit, small_unit, 0), QVector3D(small_unit * 2 + unit, small_unit + unit, 0)));//D1
			m_hotZone.push_back(Box3D(QVector3D(small_unit + unit, 0, 0), QVector3D(small_unit * 2 + unit, small_unit, 0)));//D2
			m_hotZone.push_back(Box3D(QVector3D(small_unit, 0, 0), QVector3D(small_unit + unit, small_unit, 0)));//D3
			m_hotZone.push_back(Box3D(QVector3D(0, 0, 0), QVector3D(small_unit, small_unit, 0)));//D4
			m_hotZone.push_back(Box3D(QVector3D(0, small_unit, 0), QVector3D(small_unit, small_unit + unit, 0)));//D5
			m_hotZone.push_back(Box3D(QVector3D(0, small_unit + unit, 0), QVector3D(small_unit, small_unit * 2 + unit, 0)));//D6
			m_hotZone.push_back(Box3D(QVector3D(small_unit, small_unit + unit, 0), QVector3D(small_unit + unit, small_unit * 2 + unit, 0)));//D7
			m_hotZone.push_back(Box3D(QVector3D(small_unit + unit, small_unit + unit, 0), QVector3D(small_unit * 2 + unit, small_unit * 2 + unit, 0)));//D8
		}
	...
	void HotbedEntity::setColor(int type, const QVector4D& color)
	{
